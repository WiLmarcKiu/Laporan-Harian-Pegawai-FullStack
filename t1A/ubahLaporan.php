                            ...
                            <div class="home">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        ...
                                        $dataLaporan = $koneksi->query("SELECT * FROM laporanT1A WHERE tgl_lapor = '$tgl_kemarin'");
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="jumlahPesawat_kedatangan" id="jumlahPesawat_kedatangan" value="<?= $laporan['jumlahPesawat_kedatangan']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="pengawasanTS_kedatangan" id="pengawasanTS_kedatangan" value="<?= $laporan['pengawasanTS_kedatangan']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="jumlahPesawat_keberangkatan">Jumlah Pesawat - Keberangkatan T1A <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="jumlahPesawat_keberangkatan" id="jumlahPesawat_keberangkatan" value="<?= $laporan['jumlahPesawat_keberangkatan']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="personilKeberangkatan" id="personilKeberangkatan" value="<?= $laporan['personilKeberangkatan']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="validasiManual_keberangkatan">Validasi Manual - Keberangkatan T1A <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="validasiManual_keberangkatan" id="validasiManual_keberangkatan" value="<?= $laporan['validasiManual_keberangkatan']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="validasiBy_PL">Validasi by PL - Keberangkatan T1A <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="validasiBy_PL" id="validasiBy_PL" value="<?= $laporan['validasiBy_PL']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="LTHamil_klinik" id="LTHamil_klinik" value="<?= $laporan['LTHamil_klinik']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="LTUmum_klinik">LT Umum - Klinik T1A <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="LTUmum_klinik" id="LTUmum_klinik" value="<?= $laporan['LTUmum_klinik']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="TLTHamil_klinik">TLT Hamil - Klinik T1A <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="TLTHamil_klinik" id="TLTHamil_klinik" value="<?= $laporan['TLTHamil_klinik']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="TLTUmum_klinik">TLT Umum - Klinik T1A <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="TLTUmum_klinik" id="TLTUmum_klinik" value="<?= $laporan['TLTUmum_klinik']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="rujukKlinik">Rujuk - Klinik T1A <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="rujukKlinik" id="rujukKlinik" value="<?= $laporan['rujukKlinik']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" rows="3" class="form-control" name="laporanNotifikasi_penemuanKasusCOVID" id="laporanNotifikasi_penemuanKasusCOVID" required><?= $laporan['laporanNotifikasi_penemuanKasusCOVID']; ?></textarea>
                                            </div>
                                        ...
                                        if (isset($_POST['ubah'])) {
                                            ...
                                            if (!empty($lokasi)) {
                                                ...
                                                $sql = "UPDATE laporanT1A SET
                                            jumlahPesawat_kedatangan = '$_POST[jumlahPesawat_kedatangan]',
                                            paxKedatangan = '$_POST[paxKedatangan]',
                                            personilKedatangan = '$_POST[personilKedatangan]',
                                            pengawasanTS_kedatangan = '$_POST[pengawasanTS_kedatangan]',
                                            jumlahPesawat_keberangkatan = '$_POST[jumlahPesawat_keberangkatan]',
                                            paxKeberangkatan = '$_POST[paxKeberangkatan]',
                                            personilKeberangkatan = '$_POST[personilKeberangkatan]',
                                            validasiManual_keberangkatan = '$_POST[validasiManual_keberangkatan]',
                                            validasiBy_PL = '$_POST[validasiBy_PL]',
                                            berobatKlinik= '$_POST[berobatKlinik]',
                                            LTHamil_klinik = '$_POST[LTHamil_klinik]',
                                            LTUmum_klinik = '$_POST[LTUmum_klinik]',
                                            TLTHamil_klinik = '$_POST[TLTHamil_klinik]',
                                            TLTUmum_klinik = '$_POST[TLTUmum_klinik]',
                                            rujukKlinik = '$_POST[rujukKlinik]',
                                            laporanNotifikasi_penemuanKasusCOVID = '$_POST[laporanNotifikasi_penemuanKasusCOVID]',
