                                    ...
                                    <div class="col-md-6">
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="personilKedatangan_flight" id="personilKedatangan_flight" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="paxKeberangkatan_flight" id="paxKeberangkatan_flight" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="personilKeberangkatan_flight" id="personilKeberangkatan_flight" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="validasiManual">Validasi manual T2 D-E Domestik <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="validasiManual" id="validasiManual" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="rincianValidasi_manual" id="rincianValidasi_manual" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="validasiPeduli_lindungi">Validasi Peduli Lindungi T2 D-E Domestik <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="validasiPeduli_lindungi" id="validasiPeduli_lindungi" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="rujuk" id="rujuk" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" rows="3" class="form-control" name="laporanNotif_penemuanKasusCOVID" id="laporanNotif_penemuanKasusCOVID" required></textarea>
                                            </div>
                                        ...
                                        if (isset($_POST['kirim'])) {
                                            ...
                                            $koneksi->query("INSERT INTO laporanT2DEDomestik
                                            (tgl_lapor,
                                            kedatanganFlight,
                                            paxKedatangan_flight,
                                            personilKedatangan_flight,
                                            keberangkatanFlight,
                                            paxKeberangkatan_flight,
                                            personilKeberangkatan_flight,
                                            validasiManual,
                                            rincianValidasi_manual,
                                            validasiPeduli_lindungi,
                                            berobatKlinik,
                                            LTHamil,
                                            LTUmum,
                                            TLTHamil,
                                            TLTUmum,
                                            rujuk,
                                            laporanNotif_penemuanKasusCOVID,
                                            petugas,
                                            relawanPagi,
                                            relawanMalam,
                                            ...
                                            '$_POST[personilKedatangan_flight]',
                                            '$_POST[keberangkatanFlight]',
                                            '$_POST[paxKeberangkatan_flight]',
                                            '$_POST[personilKeberangkatan_flight]',
                                            '$_POST[validasiManual]',
                                            '$_POST[rincianValidasi_manual]',
                                            '$_POST[validasiPeduli_lindungi]',
                                            '$_POST[berobatKlinik]',
                                            '$_POST[LTHamil]',
                                            '$_POST[LTUmum]',
                                            '$_POST[TLTHamil]',
                                            '$_POST[TLTUmum]',
                                            '$_POST[rujuk]',
                                            '$_POST[laporanNotif_penemuanKasusCOVID]',
                                            '$_POST[petugas]',
                                            '$_POST[relawanPagi]',
                                            '$_POST[relawanMalam]',
