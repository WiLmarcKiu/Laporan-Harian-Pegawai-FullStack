                            ...
                            <div class="home">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        ...
                                        $dataLaporan = $koneksi->query("SELECT * FROM laporanT1ShapireVIP WHERE tgl_lapor = '$tgl_kemarin'");
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="kedatanganDomestik_flight" id="kedatanganDomestik_flight" value="<?= $laporan['kedatanganDomestik_flight']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="paxKedatangan_domestik">Pax - Kedatangan Domestik T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="paxKedatangan_domestik" id="paxKedatangan_domestik" value="<?= $laporan['paxKedatangan_domestik']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="personilKedatangan_domestik">Personil - Kedatangan Domestik T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="personilKedatangan_domestik" id="personilKedatangan_domestik" value="<?= $laporan['personilKedatangan_domestik']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="keberangkatanDomestik_flight" id="keberangkatanDomestik_flight" value="<?= $laporan['keberangkatanDomestik_flight']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="paxKeberangkatan_domestik">Pax - Keberangkatan Domestik T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="paxKeberangkatan_domestik" id="paxKeberangkatan_domestik" value="<?= $laporan['paxKeberangkatan_domestik']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="personilKeberangkatan_domsetik" id="personilKeberangkatan_domsetik" value="<?= $laporan['personilKeberangkatan_domsetik']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="eHACPL_keberangkatanDomestik" id="eHACPL_keberangkatanDomestik" value="<?= $laporan['eHACPL_keberangkatanDomestik']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="noneHAC_validasiManualKeberangkatanDomestik" id="noneHAC_validasiManualKeberangkatanDomestik" value="<?= $laporan['noneHAC_validasiManualKeberangkatanDomestik']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="kedatanganINTL_flight">Kedatangan INTL (flight) T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="kedatanganINTL_flight" id="kedatanganINTL_flight" value="<?= $laporan['kedatanganINTL_flight']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="paxKedatangan_INTLFlight">Pax - Kedatangan INTL (flight) T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="paxKedatangan_INTLFlight" id="paxKedatangan_INTLFlight" value="<?= $laporan['paxKedatangan_INTLFlight']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="personilKedatangan_INTL">Personil - Kedatangan INTL T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="personilKedatangan_INTL" id="personilKedatangan_INTL" value="<?= $laporan['personilKedatangan_INTL']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="hasilScan_PLHijau">Hasil Scan PL Hijau T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="hasilScan_PLHijau" id="hasilScan_PLHijau" value="<?= $laporan['hasilScan_PLHijau']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="hasilScan_PLMerah">Hasil Scan PL Merah T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="hasilScan_PLMerah" id="hasilScan_PLMerah" value="<?= $laporan['hasilScan_PLMerah']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="tidakScan_PL">Tidak Scan PL T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="tidakScan_PL" id="tidakScan_PL" value="<?= $laporan['tidakScan_PL']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="WNIVaksinasi_COVIDLengkap">WNI - Vaksinasi COVID19 Lengkap T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="WNIVaksinasi_COVIDLengkap" id="WNIVaksinasi_COVIDLengkap" value="<?= $laporan['WNIVaksinasi_COVIDLengkap']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="WNAVaksinasi_COVIDLengkap">WNA - Vaksinasi COVID19 Lengkap T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="WNAVaksinasi_COVIDLengkap" id="WNAVaksinasi_COVIDLengkap" value="<?= $laporan['WNAVaksinasi_COVIDLengkap']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="WNIVaksinasi_COVIDBelumLengkap" id="WNIVaksinasi_COVIDBelumLengkap" value="<?= $laporan['WNIVaksinasi_COVIDBelumLengkap']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="WNAVaksinasi_COVIDBelumLengkap" id="WNAVaksinasi_COVIDBelumLengkap" value="<?= $laporan['WNAVaksinasi_COVIDBelumLengkap']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="WNIPCR_onArrival">WNI - PCR on Arrival T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="WNIPCR_onArrival" id="WNIPCR_onArrival" value="<?= $laporan['WNIPCR_onArrival']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="WNAPCR_onArrival">WNA - PCR on Arrival T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="WNAPCR_onArrival" id="WNAPCR_onArrival" value="<?= $laporan['WNAPCR_onArrival']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="keberangkatanINTL_flight">Keberangkatan INTL (flight) T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="keberangkatanINTL_flight" id="keberangkatanINTL_flight" value="<?= $laporan['keberangkatanINTL_flight']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="paxKeberangkatan_INTL">Pax - Keberangkatan INTL T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="paxKeberangkatan_INTL" id="paxKeberangkatan_INTL" value="<?= $laporan['paxKeberangkatan_INTL']; ?>" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="personilKeberangkatan_INTL">Personil - Keberangkatan INTL T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="personilKeberangkatan_INTL" id="personilKeberangkatan_INTL" value="<?= $laporan['personilKeberangkatan_INTL']; ?>" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" rows="3" class="form-control" name="rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterDOM" id="rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterDOM" required><?= $laporan['rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterDOM']; ?></textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" rows="3" class="form-control" name="rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterINT" id="rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterINT" required><?= $laporan['rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterINT']; ?></textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" rows="3" class="form-control" name="kesimpulanPemeriksaan_tandaGejalaPengawasanDokumenKesehatan" id="kesimpulanPemeriksaan_tandaGejalaPengawasanDokumenKesehatan" required><?= $laporan['kesimpulanPemeriksaan_tandaGejalaPengawasanDokumenKesehatan']; ?></textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="petugas">Petugas T1 Shapire VIP <span class="text-danger"><b>*</b></span></label>
                                                <input type="text" class="form-control" name="petugas" id="petugas" value="<?= $laporan['petugas']; ?>" required>
                                            </div>
                                        ...
                                        if (isset($_POST['ubah'])) {
                                            ...
                                            if (!empty($lokasi)) {
                                                ...
                                                $sql = "UPDATE laporanT1ShapireVIP SET
                                            kedatanganDomestik_flight = '$_POST[kedatanganDomestik_flight]',
                                            paxKedatangan_domestik = '$_POST[paxKedatangan_domestik]',
                                            personilKedatangan_domestik = '$_POST[personilKedatangan_domestik]',
                                            keberangkatanDomestik_flight = '$_POST[keberangkatanDomestik_flight]',
                                            paxKeberangkatan_domestik = '$_POST[paxKeberangkatan_domestik]',
                                            personilKeberangkatan_domsetik = '$_POST[personilKeberangkatan_domsetik]',
                                            eHACPL_keberangkatanDomestik = '$_POST[eHACPL_keberangkatanDomestik]',
                                            noneHAC_validasiManualKeberangkatanDomestik = '$_POST[noneHAC_validasiManualKeberangkatanDomestik]',
                                            kedatanganINTL_flight = '$_POST[kedatanganINTL_flight]',
                                            paxKedatangan_INTLFlight= '$_POST[paxKedatangan_INTLFlight]',
                                            personilKedatangan_INTL = '$_POST[personilKedatangan_INTL]',
                                            hasilScan_PLHijau = '$_POST[hasilScan_PLHijau]',
                                            hasilScan_PLMerah = '$_POST[hasilScan_PLMerah]',
                                            tidakScan_PL = '$_POST[tidakScan_PL]',
                                            WNIVaksinasi_COVIDLengkap = '$_POST[WNIVaksinasi_COVIDLengkap]',
                                            WNAVaksinasi_COVIDLengkap = '$_POST[WNAVaksinasi_COVIDLengkap]',
                                            WNIVaksinasi_COVIDBelumLengkap = '$_POST[WNIVaksinasi_COVIDBelumLengkap]',
                                            WNAVaksinasi_COVIDBelumLengkap = '$_POST[WNAVaksinasi_COVIDBelumLengkap]',
                                            WNIPCR_onArrival = '$_POST[WNIPCR_onArrival]',
                                            WNAPCR_onArrival = '$_POST[WNAPCR_onArrival]',
                                            keberangkatanINTL_flight = '$_POST[keberangkatanINTL_flight]',
                                            paxKeberangkatan_INTL = '$_POST[paxKeberangkatan_INTL]',
                                            personilKeberangkatan_INTL = '$_POST[personilKeberangkatan_INTL]',
                                            rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterDOM = '$_POST[rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterDOM]',
                                            rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterINT = '$_POST[rincianPemeriksaan_dokKesehatanVaksinasiCovidPesawatChapterINT]',
                                            kesimpulanPemeriksaan_tandaGejalaPengawasanDokumenKesehatan = '$_POST[kesimpulanPemeriksaan_tandaGejalaPengawasanDokumenKesehatan]',
