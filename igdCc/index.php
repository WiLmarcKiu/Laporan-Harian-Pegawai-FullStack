                                    ...
                                    <div class="col-md-6">
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="stokAwal_rapidAntibodi" id="stokAwal_rapidAntibodi" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="terimaStok_rapidAntibodi">Terima Stok - Rapid Antibodi IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="terimaStok_rapidAntibodi" id="terimaStok_rapidAntibodi" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="pemakaianRapid_antibodi">Pemakaian - Rapid Antibodi IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="pemakaianRapid_antibodi" id="pemakaianRapid_antibodi" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="hasilRapid_antibodiReaktif">Hasil Rapid Antibodi Reaktif IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="hasilRapid_antibodiReaktif" id="hasilRapid_antibodiReaktif" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="hasilRapid_antibodiNonReaktif">Hasil Rapid Antibodi Non Reaktif IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="hasilRapid_antibodiNonReaktif" id="hasilRapid_antibodiNonReaktif" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="stokAwal_rapidAntigen">Stok Awal - Rapid ANTIGEN IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="stokAwal_rapidAntigen" id="stokAwal_rapidAntigen" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="terimaStok_rapidAntigen">Terima Stok - Rapid ANTIGEN IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="terimaStok_rapidAntigen" id="terimaStok_rapidAntigen" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="pemakaianRapidAntigen">Pemakaian Rapid ANTIGEN IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="pemakaianRapidAntigen" id="pemakaianRapidAntigen" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="hasilRapid_antigenNegatif">Hasil Rapid ANTIGEN Negatif IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="hasilRapid_antigenNegatif" id="hasilRapid_antigenNegatif" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="hasilRapid_antigenPositif">Hasil Rapid ANTIGEN Positif IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="hasilRapid_antigenPositif" id="hasilRapid_antigenPositif" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="stokAkhir_rapidAntigen">Stok Akhir - Rapid ANTIGEN IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="stokAkhir_rapidAntigen" id="stokAkhir_rapidAntigen" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="pengunjungKlinik_berobatJalan">Pengunjung Klinik Berobat Jalan IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="pengunjungKlinik_berobatJalan" id="pengunjungKlinik_berobatJalan" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="pengunjungKlinik_ltSiaos">Pengunjung Klinik LT/SIAOS IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="pengunjungKlinik_ltSiaos" id="pengunjungKlinik_ltSiaos" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="pengunjungKlinik_tlt">Pengunjung Klinik TLT IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="pengunjungKlinik_tlt" id="pengunjungKlinik_tlt" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="pengunjungKlinik_meninggal">Pengunjung Klinik Meninggal IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="pengunjungKlinik_meninggal" id="pengunjungKlinik_meninggal" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="jumlahPenerbitan_dokumenSuratIzinAngkutJenazah" id="jumlahPenerbitan_dokumenSuratIzinAngkutJenazah" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="jumlahLaporan_ambulance">Jumlah Laporan Ambulance IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="jumlahLaporan_ambulance" id="jumlahLaporan_ambulance" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="jumlahLaporan_kll">Jumlah Laporan KLL IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="jumlahLaporan_kll" id="jumlahLaporan_kll" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="jumlahLaporan_kejadianK3">Jumlah Laporan Kejadian K3 IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="jumlahLaporan_kejadianK3" id="jumlahLaporan_kejadianK3" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="jumlahLaporan_kematian">Jumlah Laporan Kematian IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="jumlahLaporan_kematian" id="jumlahLaporan_kematian" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="pengirimanSampel_keBbtklpp">Pengiriman Sampel ke BBTKLPP IGD CC <span class="text-danger"><b>*</b></span></label>
                                                <input type="number" min="0" class="form-control" name="pengirimanSampel_keBbtklpp" id="pengirimanSampel_keBbtklpp" required>
                                            </div>
                                        ...
                                        if (isset($_POST['kirim'])) {
                                            ...
                                            $koneksi->query("INSERT INTO laporanIgdCc
                                            (tgl_lapor,
                                            stokAwal_rapidAntibodi,
                                            terimaStok_rapidAntibodi,
                                            pemakaianRapid_antibodi,
                                            hasilRapid_antibodiReaktif,
                                            hasilRapid_antibodiNonReaktif,
                                            stokAwal_rapidAntigen,
                                            terimaStok_rapidAntigen,
                                            pemakaianRapidAntigen,
                                            hasilRapid_antigenNegatif,
                                            hasilRapid_antigenPositif,
                                            stokAkhir_rapidAntigen,
                                            pengunjungKlinik_berobatJalan,
                                            pengunjungKlinik_ltSiaos,
                                            pengunjungKlinik_tlt,
                                            pengunjungKlinik_meninggal,
                                            jumlahPenerbitan_dokumenSuratIzinAngkutJenazah,
                                            jumlahLaporan_ambulance,
                                            jumlahLaporan_kll,
                                            jumlahLaporan_kejadianK3,
                                            jumlahLaporan_kematian,
                                            pengirimanSampel_keBbtklpp,
                                            petugas,
                                            laporanKeterangan_tambahan,
                                            formatLaporan) VALUES 
                                            ('$_POST[tgl_lapor]',
                                            '$_POST[stokAwal_rapidAntibodi]',
                                            '$_POST[terimaStok_rapidAntibodi]',
                                            '$_POST[pemakaianRapid_antibodi]',
                                            '$_POST[hasilRapid_antibodiReaktif]',
                                            '$_POST[hasilRapid_antibodiNonReaktif]',
                                            '$_POST[stokAwal_rapidAntigen]',
                                            '$_POST[terimaStok_rapidAntigen]',
                                            '$_POST[pemakaianRapidAntigen]',
                                            '$_POST[hasilRapid_antigenNegatif]',
                                            '$_POST[hasilRapid_antigenPositif]',
                                            '$_POST[stokAkhir_rapidAntigen]',
                                            '$_POST[pengunjungKlinik_berobatJalan]',
                                            '$_POST[pengunjungKlinik_ltSiaos]',
                                            '$_POST[pengunjungKlinik_tlt]',
                                            '$_POST[pengunjungKlinik_meninggal]',
                                            '$_POST[jumlahPenerbitan_dokumenSuratIzinAngkutJenazah]',
                                            '$_POST[jumlahLaporan_ambulance]',
                                            '$_POST[jumlahLaporan_kll]',
                                            '$_POST[jumlahLaporan_kejadianK3]',
                                            '$_POST[jumlahLaporan_kematian]',
                                            '$_POST[pengirimanSampel_keBbtklpp]',
                                            '$_POST[petugas]',
